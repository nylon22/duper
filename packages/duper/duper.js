...
yargs
  ...
  .command(require('@duper/config-add-cluster'))
  .command(require('@duper/config-delete-cluster'))
  .command(require('@duper/config-set-follower-cluster'))
  .command(require('@duper/config-set-leader-cluster'))
