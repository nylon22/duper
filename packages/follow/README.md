...
| -------- | ----------- | ------- | -------- | -------- |
| `follower_index` | The name of the index to create in the follower cluster. The follower cluster is the current cluster. You can set the current cluster by running "duper config switch-cluster [options]" | `string` | `f` | **True** |
| `leader_index` | The name of the index in the leader cluster to follow. | `string` | `l` | **True** |
| `remote_cluster` | The name of the remote cluster containing the leader index. | `string` | `r` | **True** |
